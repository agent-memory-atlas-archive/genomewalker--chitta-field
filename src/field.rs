...
impl ChittaField {
    ...
    pub(crate) fn open_with_ablations(data_dir: PathBuf, lock: bool, ablations: crate::ablation::Ablations) -> Result<Self> {
        ...
        Ok(Self {
            ...
            symbol_id_alloc,
            code_file_id_alloc,
            learners: crate::ablation::Organ::new(LearnerSet::new(), LearnerSet::new, ablations.disabled("learners")),
            sparse_encoder: crate::ablation::Organ::new(SparseEncoder::new(), SparseEncoder::new, ablations.disabled("sparse_encoder")),
            cortical_idx: crate::ablation::Organ::new(cortical_idx, CorticalIndex::new, ablations.disabled("cortical_idx")),
            event_id_alloc: Arc::new(AtomicU64::new(1)),
            session_registry: crate::ablation::Organ::new(session_registry, SessionRegistry::new, ablations.disabled("session_registry")),
            transcript_registry: crate::ablation::Organ::new(transcript_registry, TranscriptRegistry::new, ablations.disabled("transcript_registry")),
            task_registry: crate::ablation::Organ::new(task_registry, TaskRegistry::new, ablations.disabled("task_registry")),
            user_model_registry: crate::ablation::Organ::new(user_model_registry, UserModelRegistry::new, ablations.disabled("user_model_registry")),
            theme_organ: crate::ablation::Organ::new(theme_organ, ThemeOrgan::new, ablations.disabled("theme_organ")),
            analytics_registry: crate::ablation::Organ::new(analytics_registry, AnalyticsRegistry::new, ablations.disabled("analytics_registry")),
            msg_registry: crate::ablation::Organ::new(msg_registry, MsgRegistry::new, ablations.disabled("msg_registry")),
            skill_registry: crate::ablation::Organ::new(skill_registry, SkillRegistry::new, ablations.disabled("skill_registry")),
            agent_registry: crate::ablation::Organ::new(agent_registry, AgentRegistry::new, ablations.disabled("agent_registry")),
            constraint_store: crate::ablation::Organ::new(constraint_store, ConstraintStore::new, ablations.disabled("constraint_store")),
            trigger_store: crate::ablation::Organ::new(trigger_store, TriggerStore::new, ablations.disabled("trigger_store")),
            predictor: crate::ablation::Organ::new(predictor, AccessPredictor::new, ablations.disabled("predictor")),
            surprise_store: crate::ablation::Organ::new(surprise_store, SurpriseStore::new, ablations.disabled("surprise_store")),
            epistemic_debt_store: crate::ablation::Organ::new(epistemic_debt_store, EpistemicDebtStore::new, ablations.disabled("epistemic_debt_store")),
            integration_kernel: crate::ablation::Organ::new(integration_kernel, IntegrationKernel::new, ablations.disabled("integration_kernel")),
            surprise_learning: crate::ablation::Organ::new(surprise_learning, SurpriseLearningStore::new, ablations.disabled("surprise_learning")),
            wisdom_promotion: crate::ablation::Organ::new(wisdom_promotion, WisdomPromotionStore::new, ablations.disabled("wisdom_promotion")),
            learned_scorer: crate::ablation::Organ::new(learned_scorer, || LearnedScoringModel::new("v5.14".to_string()), ablations.disabled("learned_scorer")),
            intervention_store: crate::ablation::Organ::new(intervention_store, InterventionStore::new, ablations.disabled("intervention_store")),
            agent_protocol_store: crate::ablation::Organ::new(agent_protocol_store, AgentProtocolStore::new, ablations.disabled("agent_protocol_store")),
            wisdom_lineage_store: crate::ablation::Organ::new(wisdom_lineage_store, WisdomLineageStore::new, ablations.disabled("wisdom_lineage_store")),
            symbol_event_log: crate::ablation::Organ::new(symbol_event_log, SymbolEventLog::new, ablations.disabled("symbol_event_log")),
            lite_encoder: crate::ablation::Organ::new(loaded_lite_encoder, || None, ablations.disabled("lite_encoder")),
            ...
            repl_sessions: crate::ablation::Organ::new(loaded_repl_sessions, crate::repl_sessions::ReplSessionStore::new, ablations.disabled("repl_sessions")),
            span_store: crate::ablation::Organ::new(loaded_span_store, crate::organ::span_store::SpanStore::new, ablations.disabled("span_store")),
            ...
            hdc_idx:    crate::ablation::Organ::new(hdc_store, crate::hdc::HdcStore::new, ablations.disabled("hdc_idx")),
            event_tape:   crate::ablation::Organ::new(event_tape, crate::organ::event_tape::EventTape::new, ablations.disabled("event_tape")),
            cdawg:        crate::ablation::Organ::new(cdawg, crate::organ::cdawg::CdawgOrgan::new, ablations.disabled("cdawg")),
            episode_hdc:        crate::ablation::Organ::new(episode_hdc, crate::hdc::EpisodeHdcStore::new, ablations.disabled("episode_hdc")),
            refutation_ledger:  crate::ablation::Organ::new(refutation_ledger, crate::organ::refutation_ledger::RefutationLedger::new, ablations.disabled("refutation_ledger")),
            cec_policy_store:   crate::ablation::Organ::new(cec_policy_store, crate::organ::intervention_store::InterventionStore::new, ablations.disabled("cec_policy_store")),
            decision_tape:      crate::ablation::Organ::new(decision_tape, crate::organ::decision_tape::DecisionTape::new, ablations.disabled("decision_tape")),
            hypothesis_market:  crate::ablation::Organ::new(hypothesis_market, crate::organ::hypothesis_market::HypothesisMarket::new, ablations.disabled("hypothesis_market")),
            turiya_monitor:     crate::ablation::Organ::new(if ablations.disabled("turiya_monitor") { snap_turiya_monitor } else { turiya_monitor }, crate::organ::turiya_monitor::TuriyaMonitor::new, ablations.disabled("turiya_monitor")),
            fep_prior:          crate::ablation::Organ::new(fep_prior, crate::organ::fep_prior::FepPriorOrgan::new, ablations.disabled("fep_prior")),
            tape_tombstoned:    std::sync::atomic::AtomicU64::new(0),
            observer:           crate::organ::observer::Observer::new(),
            observer_state:     crate::ablation::Organ::new(if ablations.disabled("observer_state") { snap_observer_state } else { crate::organ::observer::ObserverState::default() }, crate::organ::observer::ObserverState::default, ablations.disabled("observer_state")),
            interaction_ledger: crate::ablation::Organ::new(snap_interaction_ledger, crate::organ::interaction_ledger::InteractionLedger::default, ablations.disabled("interaction_ledger")),
            predicate_store:    crate::ablation::Organ::new(snap_predicate_store, crate::organ::predicate_store::PredicateStore::default, ablations.disabled("predicate_store")),
